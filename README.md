...
Galamo offers a suite of well-documented tutorials and examples to guide users through its core functionalities in galaxy analysis. The tutorials are available through the [official documentation](https://github.com/astro-galamo/galamo/wiki) and GitHub repository, providing a hands-on, structured learning experience.
...
Please review the [contributing guidelines](https://github.com/astro-galamo/galamo/blob/main/CONTRIBUTING.md) before submitting.
